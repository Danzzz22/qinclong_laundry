<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Gunakan password yang kuat & unik untuk keamanan akunmu.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <p class="mt-1 text-xs text-gray-500">{{ __('Minimal 8 karakter. Gunakan kombinasi huruf, angka, dan simbol.') }}</p>
        </div>
